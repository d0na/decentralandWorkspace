...
// gltfShapeJacket.isPointerBlocker= false;
...
// jacketEntity.addComponent(
//         new OnPointerDown((e) => {
//           log("myEntity was clickedd", e)
//           gltfShapeJacket.visible = !gltfShapeJacket.visible;
...
const transform11 = new Transform({
  position: new Vector3(8.5, 0, 8.1),
  rotation: new Quaternion(
