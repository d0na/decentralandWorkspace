...
script1.spawn(messageBubble, {"text":"Welcome to \nthe PUB Shop.","fontSize":20}, createChannel(channelId, messageBubble, channelBus))
script2.spawn(galleryInfoPeach, {"text":"PUBShop wear your suit","fontSize":5,"font":"SF","color":"#000000"}, createChannel(channelId, galleryInfoPeach, channelBus))
script3.spawn(triggerArea, {"enabled":true,"onEnter":[{"entityName":"messageBubble","actionId":"open","values":{}}],"onLeave":[{"entityName":"messageBubble","actionId":"close","values":{}}]}, createChannel(channelId, triggerArea, channelBus))
script4.spawn(radio, {"startOn":false,"volume":1,"onClickText":"Radio On/Off","onClick":[{"entityName":"radio","actionId":"toggle","values":{}}]}, createChannel(channelId, radio, channelBus))
script5.spawn(nftPictureFrame, {"id":"558536","contract":"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d","style":"Classic","color":"#FFFFFF","ui":true}, createChannel(channelId, nftPictureFrame, channelBus))
script5.spawn(nftPictureFrame2, {"id":"558536","contract":"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d","style":"Classic","color":"#FFFFFF","ui":true,"uiText":"click to open"}, createChannel(channelId, nftPictureFrame2, channelBus))
script5.spawn(nftPictureFrame3, {"id":"558536","contract":"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d","style":"Classic","color":"#FFFFFF","ui":true}, createChannel(channelId, nftPictureFrame3, channelBus))
...
script8.spawn(clickArea, {"enabled":true,"onClickText":"Interact","button":"POINTER"}, createChannel(channelId, clickArea, channelBus))
script8.spawn(clickArea2, {"enabled":true,"onClickText":"Interact","button":"POINTER","onClick":[{"entityName":"messageBubble","actionId":"open","values":{}}]}, createChannel(channelId, clickArea2, channelBus))
